                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1" @if($contact->age === 1) selected  @endif>〜１９</option>
                                                    <option value="2" @if($contact->age === 2) selected  @endif>２０〜２９</option>
                                                    <option value="3" @if($contact->age === 3) selected  @endif>３０〜３９</option>
                                                    <option value="4" @if($contact->age === 4) selected  @endif>４０〜４９</option>
                                                    <option value="5" @if($contact->age === 5) selected  @endif>５０〜５９</option>
                                                    <option value="6" @if($contact->age === 6) selected  @endif>６０〜</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
